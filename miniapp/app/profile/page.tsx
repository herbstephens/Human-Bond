        ...
        <section className="space-y-3">
          ...
          {BONDS.map((b) => {
            ...
            return (
              <div
                key={b.id}
                className={`w-full bg-white rounded-2xl px-5 py-4 border ${
              ...
              >
                ...
                <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between">
                  <p className="text-[11px] font-medium text-gray-400">
                    {isInheritance
                      ? hasTickets
                        ? 'Settles per expense · 2× Kalorama ticket NFT in the vault'
                        : 'Settles per expense — nothing parked'
                      : 'No activity yet'}
                  </p>
                  <p className="text-[11px] font-black text-gray-900 font-mono">0.00 USDC</p>
                </div>
              </div>
            );
          })}
          <p className="text-[10px] text-gray-400 font-medium px-1">
            ...
            who gets what is written inside its charter (heirs &amp; shares). Bond dashboards: next build step.
          </p>
        </section>
