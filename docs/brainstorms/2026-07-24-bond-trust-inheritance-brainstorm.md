...
| ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **Weekend scope**                          | ENS subnames · 0G storage · The Graph · Selfie Check/NFC · `finalizeWorkAndDistribute()`                              | **Identical.** Only one open decision gets an answer (next row).                                                                            |
...
| **Documents on 0G storage**                    | Vows, partnership charter, milestone records                                                                      | + inheritance charter as one more document type — same infrastructure                                                                       |
